...
const TransactionPieChart = () => {
  ...
  return (
    <div className="absolute bg-white shadow-lg p-4 rounded-lg" style={{ width: "392px", height: "300px", left: "1040px", top: "130px" }}>
      <h2 className="text-center font-semibold text-lg mb-2">Total Transactions</h2>
      <PieChart width={380} height={250}>
        <Pie data={data} cx="50%" cy="50%" innerRadius={60} outerRadius={85} fill="#8884d8" dataKey="value"   labelLine={false}
