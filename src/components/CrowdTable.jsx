...
export default function CrowdTable({ searchQuery = "" }) {
  const navigate = useNavigate();
  const allTransactions = [
    {
      username: "Musa453",
      email: "musaadebolaji@gmail.com",
      campaign: "Help the needy",
      amountraised: "₦24,000",
             ...
             <div className="min-w-full">
               {currentTransactions.map((txn, index) => (
                 ...
                 >
                   ...
                   <span className="text-center truncate px-1">{txn.campaign}</span>
                   <span className="text-center truncate px-1">{txn.amountraised}</span>
